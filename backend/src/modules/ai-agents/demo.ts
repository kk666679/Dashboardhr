// AI Agents Multi-Agent System Demo
// This demonstrates the Malaysian HRMS AI Agent orchestration capabilities
...
async function demonstrateMultiAgentSystem() {
  ...
  // Initialize orchestrator with Malaysian context
  ...
  // Demo 1: Single Agent - Industrial Relations Dispute Analysis
  ...
  // Demo 2: Multi-Agent - Employee Lifecycle Orchestration
  ...
  // Demo 3: Multi-Agent - Compliance Audit
